...
# Example: ["mistral7b"]
MODEL_ALLOWLIST = ["wicleanData"]

# Common data files used by constraint-viewer.
REL_SUBJECT_CSV = DATA_DIR / "subject_constraints_types.csv"
REL_VALUE_CSV = DATA_DIR / "value_constraints_types.csv"
WIKC_LABELS = DATA_DIR / "wicleanLabels.txt"
